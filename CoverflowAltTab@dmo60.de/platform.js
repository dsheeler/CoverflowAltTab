...
PlatformCinnamon.prototype = {
    ...
    _convertConfigToSettings: function(config) {
        return {
            ...
            switch_per_monitor : config.switch_per_monitor === true,
        };
    },
...
PlatformCinnamon18.prototype = {
    ...
    _init: function() {
        ...
        extSettings.bindProperty(Settings.BindingDirection.ONE_WAY, "switch-per-monitor", "switch_per_monitor", noop);
